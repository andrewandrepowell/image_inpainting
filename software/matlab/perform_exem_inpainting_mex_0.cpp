...
mex('perform_exem_inpainting_mex_0.cpp',IPath_0,IPath_1,libs{:},'LINKFLAGS="/NODEFAULTLIB:msvcrt.lib"');
 */
...
void mexFunction(int nlhs, mxArray *plhs[],
    ...
    int patch_size = mxGetScalar(prhs[2]);
    int* iters_0 = (nlhs>1)?(int*)mxGetData(plhs[1]):NULL;
    
    /* Run algorithm */
    int iters_1 = perform_exem_inpainting_0(
